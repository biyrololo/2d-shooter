...
function updatePlayerDirMobile(){
    ...
    if(p.reload===0){
        ...
        bullets.push(new Bullet(p.gunObj.bullet, p.gunObj.bulletSpeed, p.gunObj.baseDamage * PLAYER_BOOSTS.damage, handPos, handPos, 1, -angle + Math.PI/2, true, (p.gunObj.bulletSize || 1), p.gunObj.maxDistScale || 1));
