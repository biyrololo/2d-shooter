...
class Bullet{
     ...
     */
    constructor(name, start_point, end_point, team){
        this.img = new Image();
...
function updateBullets(){
    bullets.forEach(
        ...
        if(b.dist >= MAX_DIST || collision){
            ...
            c.drawImage(b.img, 0, 0, b.img.width, b.img.height, b.pos.x-BULLET_SIZE/2, b.pos.y-BULLET_SIZE/2, BULLET_SIZE, BULLET_SIZE);
        }
    })
}